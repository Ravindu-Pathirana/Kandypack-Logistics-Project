...
INSERT INTO `city` VALUES (6,'ambalangoda'),(1,'Colombo'),(3,'Galle'),(4,'Gampaha'),(5,'Kaluthara'),(2,'Kandy');
UNLOCK TABLES;
...
INSERT INTO `product_type` VALUES (1,'Electronics'),(2,'Hardware'),(4,'Baby Care'),(5,'Adult Care'),(6,'Cloths');
UNLOCK TABLES;
...
INSERT INTO `roles` VALUES (1,'Manager',40),(2,'Driver',50),(3,'admin',100),(4,'assitant',60);
UNLOCK TABLES;
...
INSERT INTO `store` VALUES (1,'Main Store','0112345678',NULL),(2,'Kandy Store','0812345678',NULL),(3,'Main Store 2','0332247915',NULL),(4,'Colombo Main22','0714589405',1);
UNLOCK TABLES;
...
INSERT INTO `customer` VALUES (1,'John Doe','2025-01-15',1),(2,'Jane Smith','2025-02-20',2),(3,'chamodh','2025-10-19',1);
UNLOCK TABLES;
...
INSERT INTO `employee` VALUES (30,'chamodh nethsara','chamodhne','$2b$12$Kp8GB/.WCTPhoNEW8RjgL.epU/eWhgwXtrZ5OG6qeOz.qTzzRIMBK','200400213354','0712074156','2025-10-19','Active',0,1,1),(31,'Chamodh Nethsara','chamodh','$2b$12$lGu0/4ndi.x53mWCHy9Yke4CtzdGAoQgYhtNsl.A8CcNunu3gMl4C','200500213354','0712074156','2025-10-19','Active',0,2,1),(33,'driver_store2','driver_store2','$2b$12$OSq6fiNRyYUpPY//EVqrgefcOzFlcJxIRZUqo3FS.LaMeNUJr3XeK','200400213352','0332247915','2025-10-19','Active',0,2,2),(34,'admin','admin','$2b$12$Cpsv9qDbnOTrWiLvY8ZLm.pi9wJHnmqDeD7IcGIkjOe45QM2ODf86','200400213334','0712074156','2025-10-19','Active',0,3,1),(36,'ravindu pathirana','Ravindu','$2b$12$zHm8VT4prygOceB/ihdiduEIhzQIsfIUYOSrFZ1uS0U2MacE49YfC','200600213354','0713087915','2025-10-19','Active',0,4,1);
UNLOCK TABLES;
...
INSERT INTO `assistant` VALUES (36,0,'2025-10-19 20:11:30','Available',NULL);
UNLOCK TABLES;
...
INSERT INTO `driver` VALUES (31,0,'2025-10-19 16:48:58','Available',NULL),(33,0,'2025-10-19 16:58:17','Available',NULL);
UNLOCK TABLES;
...
INSERT INTO `truck` VALUES (1,1,'CBA-1234',1),(2,1,'CBA-5678',0),(3,2,'KDA-4321',1),(4,2,'LKA-8765',1),(5,1,'CAL7255',1),(6,1,'CAL8765',0),(7,1,'ABC234543',1),(8,3,'BCD456',0);
UNLOCK TABLES;
...
INSERT INTO `product` VALUES (1,'Widget A',1.5,25,1),(2,'Gadget B',2,40,1),(3,'Tool C',0.5,10,2),(4,'string',10,100,4),(5,'Hello world',10,150,4),(6,'jeans',10,1500,6);
UNLOCK TABLES;
...
-- Triggers for truckemployeeassignment
DELIMITER ;;
